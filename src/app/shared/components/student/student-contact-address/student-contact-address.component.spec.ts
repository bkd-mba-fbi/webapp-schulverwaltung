...
import { StudentContactAddressComponent } from "./student-contact-address.component";

describe("StudentContactAddressComponent", () => {
  let fixture: ComponentFixture<StudentContactAddressComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [StudentContactAddressComponent],
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(StudentContactAddressComponent);
  });
