...
describe("SubscriptionsRestService", () => {
  ...
  describe(".getSubscriptionsByCourse", () => {
    it("should get list of Subscriptions for a course", () => {
      ...
      const expectedUrl = `https://eventotest.api/Subscriptions/?filter.EventId==9704&fields=Id,EventId,EventDesignation,PersonId,Status,RegistrationDate`;
    ...
    it("should get list of Subscriptions for a course with additional params", () => {
      ...
      const expectedUrl = `https://eventotest.api/Subscriptions/?filter.EventId==9704&filter.IsOkay==1&fields=Id,EventId,EventDesignation,PersonId,Status,RegistrationDate`;
