...
import { TestsPublishComponent } from "./tests-publish.component";

describe("TestsPublishComponent", () => {
  let component: TestsPublishComponent;
  let fixture: ComponentFixture<TestsPublishComponent>;
  let debugElement: DebugElement;

  beforeEach(async () => {
    await TestBed.configureTestingModule(
      buildTestModuleMetadata({
        imports: [TestsPublishComponent],
  ...
  beforeEach(() => {
    fixture = TestBed.createComponent(TestsPublishComponent);
