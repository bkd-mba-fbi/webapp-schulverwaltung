...
export class EditAbsencesEditComponent implements OnInit, OnDestroy {
  ...
  protected readonly absenceTypes$ =
    this.presenceTypesService.confirmationTypes$;
  protected readonly incidents$ = this.presenceTypesService.incidentTypes$;
  ...
  protected readonly incidentIdErrors$ = getValidationErrors(
    this.formGroup$,
    this.submitted$,
    "incidentId",
  );
  ...
  protected readonly confirmationStates$ = this.dropDownItemsService
  ...
  protected readonly activeCategories$ =
    this.presenceTypesService.halfDayActive$.pipe(
      map((halfDayActive) =>
        halfDayActive
